...
import 'package:petstore/api_endpoints.dart'; // Import the detailed view screen

class DogFoodPage extends StatefulWidget {
  const DogFoodPage({super.key});

  @override
  _DogFoodPageState createState() => _DogFoodPageState();
}
...
class _DogFoodPageState extends State<DogFoodPage> {
  ...
  Future<void> fetchProducts() async {
    final String apiUrl = ApiEndpoints.dogfoodProducts;
    ...
    return Scaffold(
      ...
      body: isLoading
          ...
          : errorMessage.isNotEmpty
              ...
              : products.isEmpty
                  ? Center(child: Text('No dog food products available.'))
                  : Padding(
